...
<body>
	...
	<div id="mainContent" style="display:none;margin-left:20px;">
		...
		<ul class="nav nav-tabs">
			...
			<li id="groupTab"><a href="#groupList" data-toggle="tab"><spring:message code="main.group" /></a></li>
		...
		<div class="tab-content">
			...
			<!-- group tab content -->
			<div class="tab-pane" id="groupList" style="padding-top:10px">
				...
				<div id="collapseCreateGroup" class="collapse createGroup" style="width:500px;margin-left: 300px;">
					<form class="form-horizontal" id="group_form" action="aa_saveGroup" method="post" role="form" >
				...
				<aa:zone name="groupList">
					<img id="groupListLoading" style="display:none;" src="${RESOURCE}/image/common/loading.gif" />
					<div id="groupListBody">
						<div class="alert alert-error">
							<div class="collapseTrigger" data-toggle="collapse" data-target="#myGroupPanel">
								...
								<i class="icon-chevron-down"></i> 我创建的小组 (${fn:length(myGroupList)})
								<hr>
							</div>
							<div id="myGroupPanel" class="collapse in">
								<c:forEach items="${myGroupList }" var="group" varStatus="status">
									<!-- Group button -->
									<jn:PopoverButton popoverTitle="[${group.name}]" content="${group.name}"
										popoverContent="创建者:&nbsp;&nbsp;${group.ownerName}<br>成员数:&nbsp;&nbsp;${group.memberCount}<br>组简介:&nbsp;&nbsp;${group.introduction}"
										imgUrl="img?type=2&id=${group.id}">
						...
						<div class="alert alert-success">
							<div class="collapseTrigger" data-toggle="collapse"
								data-target="#joinedGroupPanel">
								<i class="icon-chevron-right" style="display:none"></i>
								<i class="icon-chevron-down"></i> 我加入的小组 (${fn:length(joinedGroupList)})
								<hr>
							</div>
						...
						<div class="alert alert-info">
							<div class="collapseTrigger" data-toggle="collapse" data-target="#otherGroupPanel">
								...
								<i class="icon-chevron-down" style="display:none"></i> 其他的小组 (${fn:length(otherGroupList)})
								<hr>
							</div>
					...
					<div id="collapseCreateRestaurantBtn"
						...
						<form class="form-search">
							<a class="btn btn-success" data-toggle="collapse"
								data-target=".createRestaurant">添加餐馆</a> <input type="text"
								class="search-query" placeholder="Search(Coming soon)">
						</form>
					</div>
						...
						<form class="form-horizontal" id="restaurant_form"
							...
							<fieldset>
								<div class="control-group" id="restaurant_name_group">
									...
									<div class="controls">
										<input type="text" class="input-large" id="restaurant_name"
								...
								<div class="control-group" id="restaurant_telphone_group">
									...
									<div class="controls">
										<input type="text" class="input-large"
											id="restaurant_telphone" name="restaurant_telphone">
										<p class="help-inline">多个用空格分隔</p>
									</div>
								</div>
								<div class="control-group" id="restaurant_introduction_group">
									<label class="control-label"
										for="restaurant_introduction_group">简介</label>
									<div class="controls">
										<textarea rows="4" class="input-large"
											id="restaurant_introduction" name="restaurant_introduction"></textarea>
									</div>
								</div>
								<div class="control-group">
									<div class="controls">
										<a class="btn btn-primary" id="createRestaurantBtn">保存</a> <a
											class="btn btn-small offset1" data-toggle="collapse"
											data-target=".createRestaurant">取消</a>
									</div>
								</div>
							</fieldset>
						</form>
