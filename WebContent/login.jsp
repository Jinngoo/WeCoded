	...
	<div class="frame">
		...
		<div class="good"></div>
			<div class="login_panel">
				...
				<div class="box">
					<input class="btn btn-success btn-large" type="button" id="submit" value="登录"></input>
			...
			<form class="form-horizontal" id="signup-form">
				<fieldset>
					<div class="control-group" id="name-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="name" onkeyup="validateInput(this)" onafterpaste="validateInput(this)">
					...
					<div class="control-group" id="nickname-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="nickname">
